    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(user.role.toUpperCase(), style: const TextStyle(fontFamily: 'Poppins', fontSize: 10, fontWeight: FontWeight.w600, color: Colors.white)),
                              ),
                            ],
                          ),
                        ),
          ...
          // Language Section
          _SectionHeader(title: 'Language / Idioma / Langue'),
          _SettingsTile(
